...
public class AnnuaireContextMock
{
    public AnnuaireContext Context { get; set; }

    private DbConnection _connection;
    private DbContextOptions<AnnuaireContext> _contextOptions;

    public AnnuaireContextMock()
    {
        _connection = new SqliteConnection("Filename=:memory:");
        _connection.Open();

        _contextOptions = new DbContextOptionsBuilder<AnnuaireContext>().UseSqlite(_connection).Options;

        Context = new AnnuaireContext(_contextOptions);
